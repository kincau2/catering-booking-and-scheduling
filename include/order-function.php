...
function catering_custom_allergy_section(){
    ...
    <div id="catering_custom_info">
        <p>我們明⽩合適的飲食對調養⾝體的重要性，為了給您的⾝體帶來更適合的湯⽔及餐單，我們希望了解您的⾝體狀況。如訂購湯⽔或⽉⼦餐時，請更新您的⾝體狀況，以便選擇更適合您的餐單。</p>
        <p><?php _e('Please select all food allergies you have:', 'catering-booking-and-scheduling'); ?></p>
        <ul>
            <li><label><input type="checkbox" name="catering_food_allergy[]" value="Peanuts"> <?php _e('Peanuts', 'catering-booking-and-scheduling'); ?></label></li>
            <li><label><input type="checkbox" name="catering_food_allergy[]" value="Gluten"> <?php _e('Gluten', 'catering-booking-and-scheduling'); ?></label></li>
            <li><label><input type="checkbox" name="catering_food_allergy[]" value="Dairy"> <?php _e('Dairy', 'catering-booking-and-scheduling'); ?></label></li>
            <li><label><input type="checkbox" name="catering_food_allergy[]" value="Seafood"> <?php _e('Seafood', 'catering-booking-and-scheduling'); ?></label></li>
            <li><label><input type="checkbox" name="catering_food_allergy[]" value="Soy"> <?php _e('Soy', 'catering-booking-and-scheduling'); ?></label></li>
            <li><label><input type="checkbox" name="catering_food_allergy[]" value="Egg"> <?php _e('Egg', 'catering-booking-and-scheduling'); ?></label></li>
